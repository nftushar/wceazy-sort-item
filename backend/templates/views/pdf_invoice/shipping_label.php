            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="4">
                <tr>
                    <td width="50%" valign="top">
                        <img class="wceazy_pi_emulator_shipping_shop_logo" width="90px" src="<?php echo WCEAZY_IMG_DIR."modules/pdf_invoice/no-image.jpg"; ?>" />
                    </td>
                    <td width="50%" valign="top" align="right">
                        <p class="wceazy_pi_emulator_shipping_order_number" style="font-size: 10px;">Order No.: <b>########</b></p>
                        <p class="wceazy_pi_emulator_shipping_weight" style="font-size: 10px;">Weight: <b>##</b></p>
                        <p class="wceazy_pi_emulator_shipping_date" style="font-size: 10px;">Shipping Date: <b>####/##/##</b></p>
                    </td>
                </tr>
            </table>
